        ...
        <>
            ...
            >
                ...
                <View className="flex justify-center items-start p-3 dark:bg-[#292727] flex-1 rounded-r-lg">
                    <Text className="font-pextrabold capitalize  dark:text-white">{item?.exercise?.name ?? 'Bài tập không tồn tại'}</Text>
                    <Text className="font-pmedium capitalize dark:text-white">Mục tiêu: {item?.exercise?.target ?? 'Bài tập không tồn tại'}</Text>
                </View>
            </TouchableOpacity>
